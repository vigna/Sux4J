...
public class SpookyHash {
	...
	public static long hash(long[] src, int start, int length,  long seed) {
		...
		System.err.println( h0 + " " + h1 );

		h11 += ((long)(remaining << 3)) << 56;

		System.err.println( h11 );
	...
	public static void main( String[] args ) {
		long[] a = new long[] { 0x5555555555555555L, 0x1111111111111111L, 0x3333333333333333L, 0xDEADBEEFDEADBEEFL, 0L, 1L, 1L, 0x5555555555555555L, 0x1111111111111111L, 0x3333333333333333L, 0xDEADBEEFDEADBEEFL, 0L, 1L, 1L, 0x5555555555555555L, 0x1111111111111111L, 0x3333333333333333L, 0xDEADBEEFDEADBEEFL, 0L, 1L, 1L, 0x5555555555555555L, 0x1111111111111111L, 0x3333333333333333L, 0xDEADBEEFDEADBEEFL, 0L, 1L, 1L };
		System.out.println( hash( a, 0, a.length, 0 ) );
		
		long t[] = new long[ 3 ];
		Hashes.spooky4( LongArrayBitVector.wrap( a ), 0, t );
