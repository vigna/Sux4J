...
public class VLLcpMonotoneMinimalPerfectHashFunction<T> extends AbstractHashFunction<T> implements Serializable, Size64 {
	...
	public static void main(final String[] arg) throws NoSuchMethodException, IOException, JSAPException {
		...
		if (byteArray) {
			...
			BinIO.storeObject(new VLLcpMonotoneMinimalPerfectHashFunction<>(keys, TransformationStrategies.prefixFreeByteArray()), functionName);
		} else {
			...
			BinIO.storeObject(new VLLcpMonotoneMinimalPerfectHashFunction<>(keys, transformationStrategy), functionName);
		}
