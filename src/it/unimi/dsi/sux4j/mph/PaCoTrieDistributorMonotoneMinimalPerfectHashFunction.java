...
public class PaCoTrieDistributorMonotoneMinimalPerfectHashFunction<T> extends AbstractHashFunction<T> implements Size64, Serializable {
	...
	public static void main(final String[] arg) throws NoSuchMethodException, IOException, JSAPException {
		...
		if (byteArray) {
			...
			BinIO.storeObject(new PaCoTrieDistributorMonotoneMinimalPerfectHashFunction<>(collection, TransformationStrategies.prefixFreeByteArray()), functionName);
		} else {
			...
			BinIO.storeObject(new PaCoTrieDistributorMonotoneMinimalPerfectHashFunction<>(collection, transformationStrategy), functionName);
		}
