...
public class ZFastTrieDistributorMonotoneMinimalPerfectHashFunction<T> extends AbstractHashFunction<T> implements Serializable {
	...
	public static void main(final String[] arg) throws NoSuchMethodException, IOException, JSAPException {
		...
		if (byteArray) {
			...
			BinIO.storeObject(new ZFastTrieDistributorMonotoneMinimalPerfectHashFunction<>(collection, TransformationStrategies.prefixFreeByteArray(), log2BucketSize, signatureWidth, tempDir), functionName);
		} else {
			...
			BinIO.storeObject(new ZFastTrieDistributorMonotoneMinimalPerfectHashFunction<>(collection, transformationStrategy, log2BucketSize, signatureWidth, tempDir), functionName);
		}
