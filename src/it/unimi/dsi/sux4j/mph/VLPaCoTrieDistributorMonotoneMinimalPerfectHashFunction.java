...
public class VLPaCoTrieDistributorMonotoneMinimalPerfectHashFunction<T> extends AbstractHashFunction<T> implements Serializable, Size64 {
	...
	public static void main(final String[] arg) throws NoSuchMethodException, IOException, JSAPException {
		...
		if (byteArray) {
			...
			BinIO.storeObject(new VLPaCoTrieDistributorMonotoneMinimalPerfectHashFunction<>(collection, TransformationStrategies.prefixFreeByteArray()), functionName);
		} else {
			...
			BinIO.storeObject(new VLPaCoTrieDistributorMonotoneMinimalPerfectHashFunction<>(collection, transformationStrategy), functionName);
		}
