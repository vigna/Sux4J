...
public class HollowTrieMonotoneMinimalPerfectHashFunction2<T> extends AbstractHashFunction<T> implements Serializable {
    public static final long serialVersionUID = 2L;
	private static final Logger LOGGER = Util.getLogger( HollowTrieMonotoneMinimalPerfectHashFunction2.class );
	...
	private final HollowTrieDistributor2<BitVector> distributor;
	 ...
	 */
	public HollowTrieMonotoneMinimalPerfectHashFunction2( final Iterable<? extends T> elements, final TransformationStrategy<? super T> transform ) throws IOException {
	 ...
	 */
	public HollowTrieMonotoneMinimalPerfectHashFunction2( final Iterable<? extends T> elements, final TransformationStrategy<? super T> transform, File tempDir ) throws IOException {
	...
	public static void main( final String[] arg ) throws NoSuchMethodException, IOException, JSAPException {
		...
		final SimpleJSAP jsap = new SimpleJSAP( HollowTrieMonotoneMinimalPerfectHashFunction2.class.getName(), "Builds an PaCo trie-based monotone minimal perfect hash function reading a newline-separated list of strings.",
				new Parameter[] {
		...
		BinIO.storeObject( new HollowTrieMonotoneMinimalPerfectHashFunction2<CharSequence>( collection, transformationStrategy, tempDir ), functionName );
