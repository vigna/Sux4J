 ...
 * a {@linkplain HollowTrieDistributor2 hollow trie} as a distributor.
 * 
 */

public class HollowTrieMonotoneMinimalPerfectHashFunction3<T> extends AbstractHashFunction<T> implements Serializable {
    public static final long serialVersionUID = 2L;
	private static final Logger LOGGER = Util.getLogger( HollowTrieMonotoneMinimalPerfectHashFunction3.class );
	...
	private final HollowTrieDistributor3<BitVector> distributor;
	 ...
	 */
	public HollowTrieMonotoneMinimalPerfectHashFunction3( final Iterable<? extends T> elements, final TransformationStrategy<? super T> transform ) throws IOException {
	 ...
	 * by the {@link HollowTrieDistributor2}, or <code>null</code> for the default temporary directory. 
	 */
	public HollowTrieMonotoneMinimalPerfectHashFunction3( final Iterable<? extends T> elements, final TransformationStrategy<? super T> transform, File tempDir ) throws IOException {
		...
		distributor = new HollowTrieDistributor3<BitVector>( bitVectors, log2BucketSize, TransformationStrategies.identity(), tempDir );
	...
	public static void main( final String[] arg ) throws NoSuchMethodException, IOException, JSAPException {
		...
		final SimpleJSAP jsap = new SimpleJSAP( HollowTrieMonotoneMinimalPerfectHashFunction3.class.getName(), "Builds an PaCo trie-based monotone minimal perfect hash function reading a newline-separated list of strings.",
				new Parameter[] {
		...
		BinIO.storeObject( new HollowTrieMonotoneMinimalPerfectHashFunction3<CharSequence>( collection, transformationStrategy, tempDir ), functionName );
