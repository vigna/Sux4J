...
public class HollowTrieMonotoneMinimalPerfectHashFunction4<T> extends AbstractHashFunction<T> implements Serializable {
    public static final long serialVersionUID = 2L;
	private static final Logger LOGGER = Util.getLogger( HollowTrieMonotoneMinimalPerfectHashFunction4.class );
	...
	private final HollowTrieDistributor4<BitVector> distributor;
	 ...
	 */
	public HollowTrieMonotoneMinimalPerfectHashFunction4( final Iterable<? extends T> elements, final TransformationStrategy<? super T> transform ) throws IOException {
	 ...
	 */
	public HollowTrieMonotoneMinimalPerfectHashFunction4( final Iterable<? extends T> elements, final TransformationStrategy<? super T> transform, File tempDir ) throws IOException {
		...
		distributor = new HollowTrieDistributor4<BitVector>( bitVectors, log2BucketSize, TransformationStrategies.identity(), tempDir );
	...
	public static void main( final String[] arg ) throws NoSuchMethodException, IOException, JSAPException {
		...
		final SimpleJSAP jsap = new SimpleJSAP( HollowTrieMonotoneMinimalPerfectHashFunction4.class.getName(), "Builds an PaCo trie-based monotone minimal perfect hash function reading a newline-separated list of strings.",
				new Parameter[] {
		...
		BinIO.storeObject( new HollowTrieMonotoneMinimalPerfectHashFunction4<CharSequence>( collection, transformationStrategy, tempDir ), functionName );
