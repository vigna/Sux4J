...
public class HollowTrieDistributorMonotoneMinimalPerfectHashFunction<T> extends AbstractHashFunction<T> implements Size64, Serializable {
	...
	public static void main(final String[] arg) throws NoSuchMethodException, IOException, JSAPException {
		...
		if (byteArray) {
			...
			BinIO.storeObject(new HollowTrieDistributorMonotoneMinimalPerfectHashFunction<>(collection, TransformationStrategies.prefixFreeByteArray(), tempDir), functionName);
		} else {
			...
			BinIO.storeObject(new HollowTrieDistributorMonotoneMinimalPerfectHashFunction<>(collection, transformationStrategy, tempDir), functionName);
		}
