...
import it.unimi.dsi.sux4j.mph.HollowTrieMonotoneMinimalPerfectHashFunction2;
...
public class HollowTrieMinimalPerfectMonotoneHashFunction2Test extends TestCase {
	...
	public void testSmall() throws IOException {
		...
		HollowTrieMonotoneMinimalPerfectHashFunction2<String> mph = new HollowTrieMonotoneMinimalPerfectHashFunction2<String>( Arrays.asList( s ), TransformationStrategies.prefixFreeIso() );
