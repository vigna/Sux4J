...
import it.unimi.dsi.sux4j.bits.SDArraySelect;
...
public class SDArraySelectTest extends RankSelectTestCase {
	...
	public void testEmpty() {
		SDArraySelect select;
		
		select = new SDArraySelect( new long[ 1 ], 64 );
		assertEquals( -1, select.select( 0 ) );
		assertEquals( -1, select.select( 1 ) );
		
		select = new SDArraySelect( new long[ 2 ], 128 );
		assertEquals( -1, select.select( 0 ) );
		assertEquals( -1, select.select( 1 ) );

		select = new SDArraySelect( new long[ 1 ], 63 );
		assertEquals( -1, select.select( 0 ) );
		assertEquals( -1, select.select( 1 ) );
		
		select = new SDArraySelect( new long[ 2 ], 65 );
		assertEquals( -1, select.select( 0 ) );
		assertEquals( -1, select.select( 1 ) );

		select = new SDArraySelect( new long[ 3 ], 129 );
		assertEquals( -1, select.select( 0 ) );
		assertEquals( -1, select.select( 1 ) );
	...
	public void testSingleton() {
		...
		select = new SDArraySelect( new long[] { 1L << 63, 0 }, 64 );
		assertSelect( select );
		...
		select = new SDArraySelect( new long[] { 1L << 63, 0 }, 128 );
		assertSelect( select );
		assertEquals( 63, select.select( 0 ) );
		assertEquals( -1, select.select( 1 ) );

		select = new SDArraySelect( new long[] { 1L << 63, 0 }, 65 );
		assertSelect( select );
		assertEquals( 63, select.select( 0 ) );
		assertEquals( -1, select.select( 1 ) );

		select = new SDArraySelect( new long[] { 1L << 63, 0, 0 }, 129 );
		assertSelect( select );
		assertEquals( 63, select.select( 0 ) );
		assertEquals( -1, select.select( 1 ) );
	}
	...
	public void testDoubleton() {
		...
		select = new SDArraySelect( new long[] { 1 | 1L << 32 }, 64 );
		assertSelect( select );
		assertEquals( 0, select.select( 0 ) );
		assertEquals( 32, select.select( 1 ) );
		assertEquals( -1, select.select( 2 ) );
		
		select = new SDArraySelect( new long[] { 1, 1 }, 128 );
		assertSelect( select );
		assertEquals( 0, select.select( 0 ) );
		assertEquals( 64, select.select( 1 ) );
		assertEquals( -1, select.select( 2 ) );

		select = new SDArraySelect( new long[] { 1 | 1L << 32, 0 }, 63 );
		assertSelect( select );
		assertEquals( 0, select.select( 0 ) );
		assertEquals( 32, select.select( 1 ) );
		assertEquals( -1, select.select( 2 ) );
		
		select = new SDArraySelect( new long[] { 1, 1, 0 }, 129 );
		assertSelect( select );
		assertEquals( 0, select.select( 0 ) );
		assertEquals( 64, select.select( 1 ) );
		assertEquals( -1, select.select( 2 ) );
	...
	public void testAlternating() {
		...
		select = new SDArraySelect( new long[] { 0xAAAAAAAAAAAAAAAAL }, 64 );
		assertSelect( select );
		for( i = 32; i-- != 1; ) assertEquals( i * 2 + 1, select.select( i ) );

		select = new SDArraySelect( new long[] { 0xAAAAAAAAAAAAAAAAL, 0xAAAAAAAAAAAAAAAAL }, 128 );
		assertSelect( select );
		for( i = 64; i-- != 1; ) assertEquals( i * 2 + 1, select.select( i ) );

		select = new SDArraySelect( new long[] { 0xAAAAAAAAAAAAAAAAL, 0xAAAAAAAAAAAAAAAAL, 0xAAAAAAAAAAAAAAAAL, 0xAAAAAAAAAAAAAAAAL, 0xAAAAAAAAAAAAAAAAL }, 64 * 5 );
		assertSelect( select );
		for( i = 32 * 5; i-- != 1; ) assertEquals( i * 2 + 1, select.select( i ) );

		select = new SDArraySelect( new long[] { 0xAAAAAAAAL }, 33 );
		assertSelect( select );
		for( i = 16; i-- != 1; ) assertEquals( i * 2 + 1, select.select( i ) );

		select = new SDArraySelect( new long[] { 0xAAAAAAAAAAAAAAAAL, 0xAAAAAAAAAAAAL }, 128 );
		assertSelect( select );
	...
	public void testSelect() {
		SDArraySelect select;
		select = new SDArraySelect( LongArrayBitVector.of( 1, 0, 1, 1, 0, 0, 0 ).bits(), 7 );
		assertSelect( select );
		assertEquals( 0, select.select( 0 ) );
	}
	...
	public void testSparse() {
		...
		select = new SDArraySelect( bitVector );
		assertSelect( select );
