...
public class GV4CompressedFunctionTest {
	...
	private void check(int size, String[] s, GV4CompressedFunction<CharSequence> mph, long[] value) {
	...
	public void testEmpty() throws IOException {
		...
		GV4CompressedFunction<String> mph = new GV4CompressedFunction.Builder<String>().keys(emptyList).codec(new Unary()).transform(TransformationStrategies.utf16()).build();
		assertEquals(-1, mph.getLong("a"));
		mph = new GV4CompressedFunction.Builder<String>().keys(emptyList).codec(new Unary()).values(LongLists.EMPTY_LIST).transform(TransformationStrategies.utf16()).build();
		assertEquals(-1, mph.getLong("a"));
	...
	public void testDuplicates() throws IOException {
		...
		final GV4CompressedFunction<String> mph = new GV4CompressedFunction.Builder<String>().codec(new Codec.Huffman()).values(l).keys(new Iterable<String>() {
			int iteration;
