...
public class TwoStepsLcpMonotoneMinimalPerfectHashFunctionTest {
	...
	public void testSortedNumbers() throws IOException, ClassNotFoundException {
		...
		TwoStepsLcpMonotoneMinimalPerfectHashFunction<String> mph = new TwoStepsLcpMonotoneMinimalPerfectHashFunction<String>( Arrays.asList( s ), TransformationStrategies.prefixFreeUtf16() );
		...
		mph = new TwoStepsLcpMonotoneMinimalPerfectHashFunction<String>( Arrays.asList( s ), new HuTuckerTransformationStrategy( Arrays.asList( s ), true ) );
