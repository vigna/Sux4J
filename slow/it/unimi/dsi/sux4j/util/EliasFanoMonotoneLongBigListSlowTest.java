...
public class EliasFanoMonotoneLongBigListSlowTest {
	...
	public void testRandom(final long n, final int k) {
		...
		final EliasFanoMonotoneLongBigList ef = new EliasFanoMonotoneLongBigList(n, m, new Elements(n, k));
	...
	@Test
	public void test35Gi() {
		testRandom(35 * (1L << 30), 9);
	}
	...
	@Test
	public void test48GiNoLower() {
		testRandom(48 * (1L << 30), 1);
	}
}
